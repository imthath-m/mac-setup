...
// @raycast.title Copy JIRA ticket Title with Hyperlink
// @raycast.title Works only if the ticket is open in the active browser window
// @raycast.mode silent
//
// Optional parameters:
...
if (title === undefined && url === undefined) {
  ...
  app.setTheClipboardTo(`[${title.replace(/[\][]/g, '').replaceAll('- Enterprise JIRA', '')}](${url})`);
